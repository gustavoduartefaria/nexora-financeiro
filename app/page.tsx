    ...
    <main className="app-shell">
      <aside className="sidebar">
        ...
        <div className="sidebar-bottom">
          <div className="plan-card">
            <span className="plan-label">PLANO ESSENCIAL</span>
            <strong>Seu financeiro em ordem</strong>
      ...
      <section className="content">
        <header className="topbar">
          <button className="mobile-brand" aria-label="Abrir menu">L</button>
          <div>
        ...
        <div className="dashboard" id="visao-geral">
          <div className="hero-row">
            <div>
              ...
              <h1>Boa tarde! <span>Aqui está seu negócio.</span></h1>
              <p className="subtitle">Acompanhe seus resultados e tome decisões com mais confiança.</p>
            </div>
          ...
          <section className="main-grid">
            ...
            <article className="panel intelligence-panel" id="analises">
              <div className="ai-title">
                ...
                <div><p className="eyebrow">ANÁLISE INTELIGENTE</p><h2>Onde você pode melhorar</h2></div>
              </div>
              ...
              <p className="ai-note">✦ Recomendações atualizadas automaticamente com base nos seus lançamentos.</p>
            </article>
          </section>
          ...
          <footer id="relatorios">Lúmina Financeiro • Clareza para decidir melhor.</footer>
        </div>
      </section>
